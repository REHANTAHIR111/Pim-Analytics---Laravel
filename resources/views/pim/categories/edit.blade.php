        ...
        <div class="flex xl:flex-row flex-col gap-3">
            <div class="px-0 flex-1 py-0 ltr:xl:mr-1 rtl:xl:ml-1">
                <div class="panel mb-5 flex items-center gap-3">
                    ...
                    <input type="number" name="sorting" id="sorting" class="form-input w-24" placeholder='0' value='{{ old('sorting', $category->sorting) }}'>
                </div>
            ...
            <div class="xl:w-96 w-full xl:mt-0 mt-6">
                ...
                <div class="mb-3 panel">
                    ...
                    <div class='mt-5'>
                        ...
                        <input type="text" name="redirection_link" id="redirection_link" class="form-input" value='{{ old('redirection_link', $category->redirection_link) }}' placeholder='Enter Redirection Link'>
                ...
                <div class="mb-3 panel space-y-3">
                    <div x-data="{ selectedType: '{{ old('selltype', $category->sell_type) ?? '' }}' }">
                        ...
                        <select class="form-select" name="selltype" id="selltype" x-model="selectedType">
                    ...
                    <div>
                        ...
                        <input type="text" name='value' id='value' class='form-input' value='{{ old('value', $category->value) }}'>
                    </div>
                </div>
                <div class="mb-3 panel space-y-3">
                    <div>
                ...
                <div class="mb-3 panel space-y-3">
                    <div>
                        ...
                        <textarea name="upload_icon" id="upload_icon" class="form-input h-20" placeholder='Icon...'>{{ old('upload_icon', $category->icon) }}</textarea>
                    </div>
                    <div>
                        <label for="brand_link">Brand Link</label>
                        <input type="text" name="brand_link" id="brand_link" class="form-input" placeholder='Link' value="{{ old('brand_link', $category->brand_link) }}">
                    </div>
                    <div>
                        ...
                        <input type="text" name="image_link" id="image_link" class="form-input" placeholder='Link' value="{{ old('image_link', $category->image_link) }}">
                    </div>
                </div>
                <div class="panel mb-3">
