<x-layout.default>
    <form action="{{ route('pim.users.update', ['id' => $users->id]) }}" method="POST">
        @csrf
            ...
            <div class="xl:w-96 w-full xl:mt-0 mt-6">
                <div class="panel mb-3">
                    ...
                    <label class="mt-5 mb-0">
                        <input type="checkbox" name="status" class="form-checkbox" value="1" {{ old('status', $users->status) == '1' ? 'checked' : '' }} />
