@php
    $oldFeatures = json_decode(old('features_json') ?? '[]', true);
    $oldSpecs = json_decode(old('specifications_json') ?? '[]', true);
@endphp
<x-layout.default>
    <form action="{{ route('pim.product.store') }}" class='form.ajax-form' method="POST">
        @csrf
        <div class="flex xl:flex-row flex-col gap-3">
            <div class="px-0 flex-1 py-0 ltr:xl:mr-1 rtl:xl:ml-1">
                <div class="mb-5" x-data="{
                    tab: 'English',
                    productNameEn: '{{ old('productNameEn') }}',
                    shortDescriptionEn: '{{ old('shortDescriptionEn') }}',
                    descriptionEn: '{{ old('descriptionEn') }}',
                    productNameAr: '{{ old('productNameAr') }}',
                    shortDescriptionAr: '{{ old('shortDescriptionAr') }}',
                        ...
                        <div x-show="tab === 'Promotion'" class="panel space-y-2" >
                            <div class="flex gap-3 items-end">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="promotion_en" class="form-input" placeholder="Enter Promotion - En" value='{{ old('promotion_en') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Promotion - Ar</label>
                                    <input type="text" name="promotion_ar" class="form-input" placeholder="Enter Promotion - Ar" value='{{ old('promotion_ar') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Promotion Color <small style='color:gray; font-size: 10px;'>Hexa Code</small></label>
                                    <input type="text" name="promotion_color" class="form-input" placeholder="Enter Value..." value='{{ old('promotion_color') }}'/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="tab === 'Badge Left'" class="panel space-y-2" >
                            <div class="flex gap-3 items-end">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="badge_left_en" class="form-input" placeholder="Enter Badge Left - En" value='{{ old('badge_left_en') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Badge Left - Ar</label>
                                    <input type="text" name="badge_left_ar" class="form-input" placeholder="Enter Badge Left - Ar" value='{{ old('badge_left_ar') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Badge Left Color <small style='color:gray; font-size: 10px;'>Hexa Code</small></label>
                                    <input type="text" name="badge_left_color" class="form-input" placeholder="Enter Value..." value='{{ old('badge_left_color') }}'/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="tab === 'Badge Right'" class="panel space-y-2" >
                            <div class="flex gap-3 items-end">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="badge_right_en" class="form-input" placeholder="Enter Badge Right - En" value='{{ old('badge_right_en') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Badge Right - Ar</label>
                                    <input type="text" name="badge_right_ar" class="form-input" placeholder="Enter Badge Right - Ar" value='{{ old('badge_right_ar') }}'/>
                                </div>

                                <div class="w-full">
                                    <label>Badge Right Color <small style='color:gray; font-size: 10px;'>Hexa Code</small></label>
                                    <input type="text" name="badge_right_color" class="form-input" placeholder="Enter Value..." value='{{ old('badge_right_color') }}'/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-1 text-sm">
                        ...
                        <div x-show="tab === 'General'" class="panel space-y-4" >
                            <div>
                                ...
                                <input
                                    ...
                                    value="http://127.0.0.1:8000/pim/product/{{ basename(old('slug')) }}"
                                    readonly
                                />
                            </div>
                            <div class='my-3 grid grid-cols-4 gap-3'>
                                <div>
                                    ...
                                    <input type="number" name="regular_price" id="regular_price" placeholder='0.00' class="form-input" value='{{ old('regular_price') }}'>
                                    @error('regular_price')
                                        <small style="color: #b91c1c;" class="mt-1">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="sale_price" id="sale_price" placeholder='0.00' class="form-input" value='{{ old('sale_price') }}'>
                                </div>
                                <div>
                                    <label for="">Sorting</label>
                                    <input type="number" name="sorting" id="sorting" placeholder='0' class="form-input" value='{{ old('sorting') }}'>
                                    @error('sorting')
                                        <small style="color: #b91c1c;" class="mt-1">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="bundle_price" id="bundle_price" placeholder='0.00' class="form-input" value='{{ old('bundle_price') }}'>
                                </div>
                                <div>
                                    <label for="">Promo Price</label>
                                    <input type="number" name="promo_price" id="promo_price" placeholder='0.00' class="form-input" value='{{ old('promo_price') }}'>
                                </div>
                                <div>
                                    <label for="">Promo Title - En</label>
                                    <input type="text" name="promo_title" id="promo_title" placeholder='Enter Promo Title' class="form-input" value='{{ old('promo_title') }}'>
                                </div>
                                <div>
                                    <label for="">Promo Title - Ar</label>
                                    <input type="text" name="promo_title_ar" id="promo_title_ar" placeholder='Enter Promo Title - Ar' class="form-input" value='{{ old('promo_title_ar') }}'>
                                </div>
                            </div>
                            <div>
                                <label>Notes</label>
                        ...
                        <div x-show="tab === 'Inventory'" class="panel space-y-2" >
                            <div class="grid grid-cols-4 gap-3 mb-3 items-end">
                                <div>
                                    <label for="">SKU</label>
                                    <input type="text" name="sku" id="sku" class="form-input" value='{{ old('sku') }}'>
                                    @error('sku')
                                        <small style="color: #b91c1c;" class="mt-1">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="mpn_flix_media" id="mpn_flix_media" class="form-input" value='{{ old('mpn_flix_media') }}'>
                                </div>
                                <div>
                                    <label for="">MPN Flix En</label>
                                    <input type="text" name="mpn_flix_media_en" id="mpn_flix_media_en" class="form-input" value='{{ old('mpn_flix_media_en') }}'>
                                </div>
                                <div>
                                    <label for="">MPN Flix Ar</label>
                                    <input type="text" name="mpn_flix_media_ar" id="mpn_flix_media_ar" class="form-input" value='{{ old('mpn_flix_media_ar') }}'>
                                </div>
                                <div>
                                    <label for="">ln-SKU</label>
                                    <input type="text" name="ln_sku" id="ln_sku" class="form-input" value='{{ old('ln_sku') }}'>
                                </div>
                                <div>
                                    <label for="">Quantity</label>
                                    <input type="number" name="quantity" id="quantity" placeholder='0' class="form-input" value='{{ old('quantity') }}'>
                                </div>
                                <div>
                                    <label for="">Amazon Stock</label>
                                    <input type="number" name="amazon_stock" id="amazon_stock" placeholder='0' class="form-input" value='{{ old('amazon_stock') }}'>
                                </div>
                                <label>
                                    <input
                                        type="checkbox"
                                        ...
                                        class="form-checkbox"
                                        value="1"
                                        {{ old('check_in_sku_qty') == '1' ? 'checked' : '' }}
                                    />
                        ...
                        <div x-show="tab === 'Linked Products'" class="panel space-y-2" >
                                ...
                                <select name="upsale_items[]" id="upsale_items" class="w-full form-multiselect" multiple>
                                    ...
                                    @if(is_iterable($upsaleOptions))
                                        @foreach($upsaleOptions as $upsales)
                                            <option value="{{ $upsales->id }}" {{ (collect(old('upsale_items'))->contains($upsales->id)) ? 'selected' : '' }}>
                                                {{ $upsales->sku }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="grid grid-cols-2 gap-3" style="margin-top:20px" x-data="{ selectedType: '{{ old('type') }}' }">
                                <div>
                                    <label for="">Select Type</label>
                                   <select name="type" id="type" class="w-full form-select"
                                        x-model="selectedType"
                                        x-init="selectedType = '{{ old('type', '1') }}'">
                                        ...
                                        <select name="brand[]" id="brand" class="w-full form-multiselect" multiple>
                                            ...
                                            @if(is_iterable($brandOptions))
                                                @foreach($brandOptions as $brand)
                                                    <option value="{{ $brand->id }}" {{ (collect(old('brand'))->contains($brand->id)) ? 'selected' : '' }}>
                                                        {{ $brand->name }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        ...
                                        <select name="category[]" id="category" class="w-full form-multiselect" multiple>
                                            ...
                                            @if(is_iterable($categoryOptions))
                                                @foreach($categoryOptions as $category)
                                                    <option value="{{ $category->id }}" {{ (collect(old('category'))->contains($category->id)) ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            @endif
                        ...
                        <div x-show="tab === 'Setting'" class="panel space-y-2" >
                            <div class="grid grid-cols-2 gap-3">
                                <div class="w-full">
                                    ...
                                    <input type="text" name="custom_badge_en" class="form-input" placeholder="Text Goes Here" value='{{ old('custom_badge_en') }}'/>
                                </div>
                                <div class="w-full">
                                    <label>Custom Badge - Ar</label>
                                    <input type="text" name="custom_badge_ar" class="form-input" placeholder="Text Goes Here" value='{{ old('custom_badge_ar') }}'/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5"
                    x-data='{
                        tab: "MetaData - En",
                        metatitle: @json(old("metatitle")),
                        metatags: @json(old("metatags")),
                        meta_canonical: @json(old("meta_canonical")),
                        metadescription: @json(old("metadescription")),
                        metatitleAr: @json(old("metatitleAr")),
                        metatagsAr: @json(old("metatagsAr")),
                        meta_canonicalAr: @json(old("meta_canonicalAr")),
                        metadescriptionAr: @json(old("metadescriptionAr"))
                    }'>
                    <div>
                        <ul class="flex flex-wrap mt-3">
                            <li>
            ...
            <div class="xl:w-96 w-full xl:mt-0 mt-6">
                    ...
                    <div class="flex flex-wrap gap-3 mt-3">
                        ...
                        <label class="mt-3 mb-0">
                            <input
                                ...
                                class="form-checkbox"
                                value="1"
                                {{ old('enable_pre_product') == '1' ? 'checked' : '' }}
                            />
                ...
                <div class='mb-3 panel space-y-4'>
                        ...
                        <select name="product_faqs[]" id="product_faqs" class="w-full form-multiselect" multiple>
                            ...
                            @if(is_iterable($product_faqsOptions))
                               @foreach($product_faqsOptions as $faq)
                                    <option value="{{ $faq->id }}" {{ in_array($faq->id, old('product_faqs', [])) ? 'selected' : '' }}>
                                        {{ $faq->title }}
                                    </option>
                                @endforeach
                            @endif
                        ...
                        <select name="product_tags[]" id="product_tags" class="w-full form-multiselect" multiple>
                            ...
                            @if(is_iterable($product_tagsOptions))
                                @foreach($product_tagsOptions as $tags)
                                    <option value="{{ $tags->id }}" {{ in_array($tags->id, old('product_tags', [])) ? 'selected' : '' }}>
                                        {{ $tags->name }}
                                    </option>
                                @endforeach
                            @endif
                    ...
                    <div>
                        ...
                        <select id="product_brands" class="form-select" name="product_brands">
                            ...
                            @if(is_iterable($brandOptions))
                                @foreach($brandOptions as $brand)
                                    <option value="{{ $brand->id }}" {{ old('product_brands') == $brand->id ? 'selected' : '' }}>
                                        {{ $brand->name }}
                                    </option>
                                @endforeach
                            @endif
                        ...
                        <select name="product_categories[]" id="product_categories" class="w-full form-multiselect" multiple>
                            ...
                            @if(is_iterable($categoryOptions))
                                @foreach($categoryOptions as $product_categories)
                                    <option value="{{ $product_categories->id }}" {{ (collect(old('product_categories'))->contains($product_categories->id)) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="warranty" id="warranty" placeholder="Text Goes Here" class="form-input" value='{{ old('warranty') }}'>
                    </div>

                    <div class="flex flex-wrap gap-3" style="margin-top:28px;" x-data='{
                        best_selling: "{{ old('best_selling_product') ? "1" : "" }}",
                        free_gift: "{{ old('free_gift_product') ? "1" : "" }}",
                        low_in_stock: "{{ old('low_in_stock') ? "1" : "" }}",
                        top_selling: "{{ old('top_selling') ? "1" : "" }}",
                        installation: "{{ old('installation') ? "1" : "" }}",
                        is_bundle: "{{ old('is_bundle') ? "1" : "" }}",
                        product_installation: "{{ old('product_installation') ? "1" : "" }}",
                        google_merchant: "{{ old('google_merchant') ? "1" : "" }}"
                    }'>
                        <label>
                ...
                <div class="panel mb-3" x-data="{ imageUrl: '{{ old('featured_image') }}' }">
                ...
                <div class="panel mb-3">
                    ...
                    <input type="hidden" id="image_website_hidden" name="image_website" value="{{ $image_website }}">
                </div>
            </div>
        </div>
    </form>
    ...
    <script>
        function featureRepeater(oldFeatures = []) {
            return {
                features: oldFeatures.length > 0 ? oldFeatures : [{
                    en: '',
                    ar: '',
                    image: ''
                }],
        ...
        function nestedSpecRepeater(oldSpecs = []) {
            return {
                specGroups: oldSpecs.length > 0 ? oldSpecs : [
                    {
                        specs_heading: '',
                        specs_headingAr: '',
                        specsList: [{
