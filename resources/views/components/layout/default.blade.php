...
<head>
    ...
    <title>{{ $title ?? 'PIM Analytics | Tamkeen Stores' }}</title>
...
<body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden bg-[#F6F8FA]"
    ...
    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">
        ...
        <x-common.sidebar :modules="$modules"/>
